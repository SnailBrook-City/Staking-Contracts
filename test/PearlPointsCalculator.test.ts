...
describe("PearlPointsCalculator", function () {
  ...
  describe("setPoolPearlMultiplier", function () {
    ...
    it("Should revert when calling renounceOwnership", async function () {
      await expect(pearlPointsCalculator.renounceOwnership()).to.be.revertedWith("Renouncing ownership is disabled");
    });
  });
